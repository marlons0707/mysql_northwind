...
-- Volcando datos para la tabla northwind.customers: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla northwind.employees: ~9 rows (aproximadamente)
...
-- Volcando estructura para tabla northwind.employee_privileges
...
-- Volcando datos para la tabla northwind.employee_privileges: ~0 rows (aproximadamente)
...
-- Volcando estructura para tabla northwind.inventory_transactions
...
-- Volcando datos para la tabla northwind.inventory_transactions: ~102 rows (aproximadamente)
...
-- Volcando estructura para tabla northwind.inventory_transaction_types
...
-- Volcando datos para la tabla northwind.inventory_transaction_types: ~4 rows (aproximadamente)
...
-- Volcando estructura para tabla northwind.invoices
...
-- Volcando datos para la tabla northwind.invoices: ~35 rows (aproximadamente)
...
-- Volcando datos para la tabla northwind.orders: ~48 rows (aproximadamente)
...
-- Volcando estructura para tabla northwind.orders_status
...
-- Volcando datos para la tabla northwind.orders_status: ~4 rows (aproximadamente)
...
-- Volcando estructura para tabla northwind.orders_tax_status
...
-- Volcando datos para la tabla northwind.orders_tax_status: ~2 rows (aproximadamente)
...
-- Volcando estructura para tabla northwind.order_details
...
-- Volcando datos para la tabla northwind.order_details: ~58 rows (aproximadamente)
...
-- Volcando estructura para tabla northwind.order_details_status
...
-- Volcando datos para la tabla northwind.order_details_status: ~6 rows (aproximadamente)
...
-- Volcando estructura para tabla northwind.privileges
...
-- Volcando datos para la tabla northwind.privileges: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla northwind.products: ~45 rows (aproximadamente)
...
-- Volcando estructura para tabla northwind.purchase_orders
...
-- Volcando datos para la tabla northwind.purchase_orders: ~28 rows (aproximadamente)
...
-- Volcando estructura para tabla northwind.purchase_order_details
...
-- Volcando datos para la tabla northwind.purchase_order_details: ~55 rows (aproximadamente)
...
-- Volcando estructura para tabla northwind.purchase_order_status
...
-- Volcando datos para la tabla northwind.purchase_order_status: ~4 rows (aproximadamente)
...
-- Volcando estructura para tabla northwind.sales_reports
...
-- Volcando datos para la tabla northwind.sales_reports: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla northwind.shippers: ~0 rows (aproximadamente)
...
-- Volcando estructura para tabla northwind.strings
...
-- Volcando datos para la tabla northwind.strings: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla northwind.suppliers: ~0 rows (aproximadamente)
